...
spectrums = idft_output_min(dft_shift)
...
spectrums = idft_output_min(dft_shift,25)
...
spectrums = idft_output_min(dft_shift,50)
...
spectrums = idft_output_min(dft_shift,75)
...
spectrums = idft_output_min(dft_shift,100)
...
spectrums = idft_output_max(dft_shift)
...
spectrums = idft_output_max(dft_shift,25)
...
spectrums = idft_output_max(dft_shift,50)
...
spectrums = idft_output_max(dft_shift,75)
...
spectrums = idft_output_max(dft_shift,100)
